...
console.log('The removed item was:', mistake);
console.log('The updated array is', supplyChanges);
...
console.log('There are', totalParts, 'leftover parts');
console.log('There are', numberOfBoxes, 'filled boxes in total');